...
import WordBattlePracticePage from './pages/WordBattlePracticePage'
  ...
  return (
    <Router>
      <Routes>
        ...
        />
        <Route
          path="/games/word-battle/practice"
          element={username ? <WordBattlePracticePage username={username} onLogout={handleLogout} /> : <Navigate to="/" />}
        />
        <Route
          path="/profile"
